...
<div class="page">
  <div class="pagebox">
    ...
    <div class="main">
      <div class="fullcontainer">
        <div class="fulltitlebar">
          <div class="tab tabactive">链接无效</div>
        </div>
        <div class="fullcontent">
			<div class="fullcenter"><img src="<%=request.getContextPath()%>/images/image_activation_fail.gif"/><br /><br /><br /><h3>链接无效<font color="red"><span id="show"></span></font>秒后自动转到首页</h3><br/><br/><br/><br/><br/><br/></div>
        </div>
      </div>
      <div class="clear">&nbsp;</div>
    </div>
	...
	function refer(){
	if(t==0){
<%-- 	location="<%=request.getContextPath()%>";  //#设定跳转的链接地址 --%>
	clearInterval(refer());
	}
