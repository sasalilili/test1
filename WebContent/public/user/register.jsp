...
<div class="right">
  <div class="box">
    <div class="title">账号注册</div>
      ...
      <input id="inputpassword" autocomplete="off" name="password" type="password" onfocus="inputfocus('password');" onblur="inputblur('password'),checkPassword()" class="itext"/>
      <div class="itip" >
        <label id="passwordlabel" for="inputpassword" class="ilabel">输入密码</label>
        <span class="err" id="tip-password"></span> 
      </div>
      
      <input id="inputpassword2" autocomplete="off" name="confpassword" type="password" onfocus="inputfocus('password2');" onblur="inputblur('password2'),checkPasswordConf()" class="itext"/>
      <div class="itip">
     ...
     <div class="ilink2"><input id="rule" name="rule" type="checkbox" value="1" />我已阅读并同意相关<a href="<%=request.getContextPath() %>/public/eula.jsp" target="_blank">服务条款</a></div>
      ...
      <a href="javascript:void(0);" class="igraybtn l" onclick="parent.slideright();">返回</a><a href="javascript:void(0);" class="ibluebtn r"  id="terminal_user_add_dlg_save_btn" >注册</a>
      <div class="clear"></div>
