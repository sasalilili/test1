...
<div class="page">
  <div class="pagewhite">
    <div class="pagemain" style="padding-bottom:124px">
      ...
      <a href="<%=request.getContextPath() %>/" class="bluelinebutton" style="margin:40px auto 0 auto">返回首页</a>
      </div>
    </div>
    <div class="footer" style="height:124px;line-height:60px;"><a href="#"><img src="<%=request.getContextPath() %>/image/logo_big.gif" width="95" height="64" /></a><br />Copyright &copy; 2014 <a href="http://www.zhicloud.com" target="_blank">致云科技有限公司</a>, All rights reserved.　　蜀ICP备14004217号-1</div>
  </div>
</div>
</body>
</html>