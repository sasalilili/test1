    ...
    <div class="pagemain">
      <div class="box" style="height:114px;">
        <div class="titlebar">
          ...
          <div class="r"><a href="qanda.do">Q&amp;A</a>　|　<a href="serverhelp.do">使用指南</a>　|　<a href="downloadPage.do" class="active">相关下载</a>　|　<a href="hotline.do">服务热线</a></div>
          <div class="clear"></div>
        </div>
      </div>
      <a  href="/download/<%=AppProperties.getValue("client_version_name", "")%>" class="download" style="margin-top:60px">致云客户端</a>
      <a href="/download/FileZillaServercn.rar" class="download" style="margin-top:60px">ftp客户端</a>
<!--       <a href="/download/clouduan_client_x64.exe" class="download" style="">远程连接客户端64Bit</a> -->
      <!-- <a href="#" class="download" style="">FTP客户端</a> -->
    </div> 
