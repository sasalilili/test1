		...
		<input type="hidden" name="region" value="<%=region%>" />
			<table style="margin-top:10px;">
				<tr style="padding-top:30px;">
					<td>最低配置：</td>
					<td><input type="text" id="bandwidth_min" name="minBandwidth" value="<%="1".equals(region)?bandwidthMin_1:bandwidthMin_4%>" width="20px" size="10" onblur="checkBandwidthMinAndMax()"/>&nbsp;&nbsp;M</td>
				</tr>
				<tr style="padding-top:30px;">
					<td>最高配置：</td>
					<td><input type="text" id="bandwidth_max" name="maxBandwidth" value="<%="1".equals(region)?bandwidthMax_1:bandwidthMax_4%>" size="10" onblur="checkBandwidthMinAndMax()" />&nbsp;&nbsp;M</td>
				</tr>
				<tr>
					<td>计费规则：</td>
					<td><input type="radio" checked="checked" name=""/>&nbsp;5M以内&nbsp;&nbsp;<input id="bandwidth_less_than_five" type="text" name="bandwidthLessThanFive" value="<%="1".equals(region)?bandwidthLessThanFive:bandwidthLessThanFive_4 %>" size="7" maxlength="7" onblur="checkBandwidthLessThanFive()"/>&nbsp;&nbsp;元/M/月,
						5M以上<input id="bandwidth_equal_five" type="text" name="bandwidthEqualFive" value="<%="1".equals(region)?bandwidthEqualFive:bandwidthEqualFive_4 %>" size="7" maxlength="7" onblur="checkBandwidthEqualFive()"/>&nbsp;&nbsp;+&nbsp;&nbsp;(带宽-5)*
						<input id="bandwidth_base" type="text" name="bandwidthBase" value="<%=bandwidthBase %>" size="7" maxlength="7" onblur="checkBandwidthBase()"/>元/M/月
					</td>
				</tr>
				<tr>
