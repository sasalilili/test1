...
<%
	List<CloudHostVO> selfUseCloudHostList = (List<CloudHostVO>)request.getAttribute("selfUseCloudHostList");
	if(selfUseCloudHostList.isEmpty()) {
		%>
...
<div id="cloud_host_item_other_oper_menu" style="display:none; width:150px;">
    ...
    <div class="open-port" data-options="iconCls:'icon-add'">开放端口</div>
    <div class="modify-allocation" data-options="iconCls:'icon-edit'">修改配置</div>
    <div class="binding-terminal" data-options="iconCls:'icon-add'">绑定云终端</div>
    <div class="modify_password" data-options="iconCls:'icon-add'">修改监控密码</div>
