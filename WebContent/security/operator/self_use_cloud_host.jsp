...
<html>
	...
	<body> 
		<form id="big_form" method="post">
			...
			<div id="toolbar" class="datagrid-toolbar" style="padding: 3px;">
				<div style="display: table; width: 100%;">
					<div style="display:table-cell; text-align:left">
						<a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true" id="create_cloud_host_btn">创建云主机</a> 
					</div>
			...
			<div id="cloud_host_item_all_box" style="overflow-y:auto;">
			</div>
	...
	$(document).ready(function(){
		...
		// 布局初始化
		$("#cloud_host_item_all_box").height($(document.body).height() - $("#titlebar").height() - $("#toolbar").height() - 18);
		// 初始仳
		self.query();
	});
	</script>
