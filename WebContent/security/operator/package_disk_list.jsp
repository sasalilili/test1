	...
	<body>
		...
		<input type="hidden" name="region" value="<%=region %>" />
			<table style="margin-top:10px;">
				...
				<tr>
					<td>计费规则：</td>
					<td><input type="radio" checked="checked" name=""/>&nbsp;<input id="price_of_one" type="text" name="priceOfOne" value="<%="1".equals(region)?diskPriceOfOne:diskPriceOfOne_4 %>" size="7" onblur="checkPriceOfOne()" maxlength="7"/>&nbsp;&nbsp;元/G/月</td>
				</tr>
				<tr>
