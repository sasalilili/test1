...
<html>
	...
	<div class="iframe">
		...
		<div id="package_option_manage_dlg" title="套餐项管理" style="padding:10px;">	
			...
			<div id="cpu_package_add_dlg" title="CPU套餐项管理" style="padding:10px 0 10px 0;">
				<form id="cpu_package_add_dlg_form" method="post">
					<table id="cpu_datagrid" style="width:760px;">
						<tr>
							<td width="90px;">CPU套餐项：</td>
							<td>
								<div>
									<input id="core" name="core"  maxlength="10" style="width:50px"
										data-options="
											precision: 0,
											min: 0
										"
									/>
									核&nbsp;&nbsp;
									<a href="#" class="easyui-linkbutton" id="add_core">添加</a> 
								</div>
							</td>
						</tr>
						<tr>
							<td></td>
							<td>
								<div id="core_box" style="width:600px; padding:10px 0 5px 0;">				
									<%
			...
			<div id="memory_package_add_dlg"  title="内存套餐项管理" style="padding:10px 0 10px 0;">
				<form id="memory_package_add_dlg_form" method="post">
					<table id="memory_datagrid" style="width:760px;">
						<tr>
							<td width="90px;">内存套餐项：</td>
							<td>
								<div>
									<input id="memory" name="memory" maxlength="10" style="width:50px"
										data-options="
											precision: 4,
											min: 0
										"
									/>
									GB&nbsp;&nbsp;
									<a href="#" class="easyui-linkbutton" id="add_memory">添加</a> 
								</div>
							</td>
						</tr>
						<tr>
							<td></td>
							<td>
								<div id="memory_box" style="width:600px; padding:10px 0 5px 0;"">				
									<%
			...
			<div id="disk_package_add_dlg"  title="磁盘套餐项管理" style="padding:10px 0 10px 0;">
				<form id="disk_package_add_dlg_form" method="post">
					<table style="width:760px;">
						<tr>
							...
							<td width="120px;">
								最小
								<input id="disk_min" type="text" name="disk_min" style="width:50px"
									data-options="
										precision: 0,
										min: 0
									"
							...
							<td width="150px;">
								最大
								<input id="disk_max" type="text"  name="disk_max"  style="width:50px"
									data-options="
										precision: 0,
										min: 0
									"
			...
			<div id="bandwidth_package_add_dlg"  title="宽带套餐项管理" style="padding:10px 0 10px 0;">
				<form id="bandwidth_package_add_dlg_form" method="post">
					<table style="width:760px;">
						<tr>
							...
							<td width="120px;">
								最小
								<input  id="bandwidth_min" type="text" name="bandwidth_min" style="width:50px"
									data-options="
										precision: 0,
										min: 0
									"
							...
							<td width="150px;">
								最大
								<input  id="bandwidth_max" type="text" name="bandwidth_max" style="width:50px"
									data-options="
										precision: 0,
										min: 0
									"
			...
			<div id = "trial_period_param_manage_dlg" title="试用期管理" style="padding:10px 0 10px 0;">
				...
				<form id="cloud_host_add_dlg_form" method="post">
					...
					<table  style="width:760px;">
						<tr>
							<td width="90px;">试用期：</td>
							<td width="150px;">
								<label for="check1">
									<input type="checkbox"  id = "check1" name = "check1" >是否启用云主机试用期&nbsp;&nbsp;
								</label>
							</td>
							<td width="150px;">
								试用期
								<input type = "text"  id="day1" name="day1"  style="width:50px" value="<%=trialPeriodCloudHost.getDay() %>" 
									data-options="
										precision: 0,
										min: 0
									"
						...
						<tr>
							...
							<td>
								<label for="check2">
									<input type="checkbox"  id="check2" name="check2" >是否启用云存储试用期&nbsp;&nbsp;
								</label>
							</td>
							<td>
								试用期
								<input type="text"  id="day2" name="day2" style="width:50px" value="<%=trialPeriodCloudDisk.getDay()%>"
									data-options="
										precision: 0,
										min: 0
									" 
...
<!-- 							<td align="right"> -->
<!-- 								&nbsp;&nbsp; -->
<!-- 								<a href="javascript:" class="easyui-linkbutton"  data-options="iconCls:'icon-save'" id="package_option_dlg_save_btn" > &nbsp;保存&nbsp; </a> -->
<!-- 							</td> -->
						</tr>
					</table>
					<hr>
