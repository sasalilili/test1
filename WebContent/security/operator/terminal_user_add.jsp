...
<!-- 		      <td class="inputcont"><select class="inputselect"  id="group_id" name="group_id" onblur="checkGroupId()" style="width:186px;height:27px;font-family:'微软雅黑';vertical-align:middle;"> -->
...
<!-- 		    </tr> -->
		    ...
		    <%-- <tr style="height:56px;">
		      ...
		      <td class="inputcont"><input class="textbox inputtext" type="password" style="width:180px;height:24px" id="password" name="password" onblur="checkPassword()"/></td>
		      <td class="inputtip" id="operator-tip-password"><i>密码由字母、数字和下划线<br/>组成，长度为8-20个字符</i></td>
		    </tr>
		    <tr>
		      ...
		      <td class="inputcont"><input class="textbox inputtext" type="password" style="width:180px;height:24px" id="confirm" name="confirm" onblur="checkPasswordConf()"/></td>
		      <td class="inputtip" id="operator-tip-confirm"><i>请再次输入密码</i></td>
		    </tr> 
		    
		    <tr style="height:56px;">
		      <td class="inputtitle"><img src="<%=request.getContextPath() %>/images/button_required_red_16_16.gif" width="12" height="12" alt="必填" />e-mail：</td>
		      <td class="inputcont"><input class="textbox inputtext" type="text" style="width:180px;height:24px" id="email" name="email" onblur="checkEmail()"/></td>
