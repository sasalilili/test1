...
<div class="page">
  <div class="pageleft">
    ...
    <div class="main">
      <div class="titlebar">
        <div class="tabbar l"><a href="#" id="base_info">基本信息</a>　｜　<a href="#" id="recharge">账户充值</a>　｜　<a href="#" id="cash_coupon">现金券</a>　｜　<a href="<%=request.getContextPath()%>/bean/ajax.do?userType=<%=userType%>&bean=invoiceService&method=managePage" class="active">发票管理</a></div>
      </div>
