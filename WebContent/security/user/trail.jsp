      ...
      <div class="navbox">
        ...
        <div id="cartpopup">
          ...
          <div id="cartpopup1" style="display:none;">
            <div class="cartpopupbox">
              <table cellspacing="0">
                <tr class="oddrow">
                  ...
                  <td class="remove"><a href="#"><img src="<%=request.getContextPath()%>/images/button_remove_gray_16_16.png" width="16" height="16" alt="删除" /></a></td>
                </tr>
                <tr>
                  <td class="image"><img src="<%=request.getContextPath()%>/images/icon_product_1.png" width="20" height="20" alt="云主机" /></td>
            ...
            <div class="clear"></div>
            <a href="#" class="viewcartbutton">去购物车结算</a> </div>
