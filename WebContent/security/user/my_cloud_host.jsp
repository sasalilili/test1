...
<div class="page">
  <div class="pageleft">
    ...
    <div class="main">
      <div class="titlebar">
        <div class="tabbar l"><a id="all_cloud_host" name="cloud_host" region="0" href="javascript:void(0);" class="active">全部</a>　｜　<a id="guangzhou_cloud_host" region="1" name="cloud_host" href="javascript:void(0);">广州</a>　｜　<a id="hongkang_cloud_host" region="4" name="cloud_host" href="javascript:void(0);">香港</a></div>
        <a href="<%=request.getContextPath() %>/buy.do?flag=buy" style="cursor:pointer;" class="greenbutton r">创建云主机</a></div>
         <div style="width:720px;padding: 16px 0 0 0; margin:0 auto;">
      ...
      <div id="one_cloud_host" style="width:720px;padding: 6px 0 0 0; margin:0 auto;">
        <table id="my_warehouse_datagrid" class="easyui-datagrid" data-options="border:false,showHeader:false,scrollbarSize:0,width:720">
          <thead>
            <tr>
                     ...
                     <%} %>
                      ...
                      <%if(cloudHost.getSysImageName()!=null){ %>
	                      <%if(cloudHost.getSysImageName().contains("indows7")){%>
	                      		<a href="javascirpt:;" class="newbtn windows7" title="<%=cloudHost.getSysImageName()%>">&nbsp;</a>
	                      <%}else if(cloudHost.getSysImageName().contains("indows2003")){%>
	                    	  	<a href="javascirpt:;" class="newbtn windows2003" title="<%=cloudHost.getSysImageName()%>">&nbsp;</a>
	                      <%}else if(cloudHost.getSysImageName().contains("indows2008")){%>
	              	      		<a href="javascirpt:;" class="newbtn windows2008" title="<%=cloudHost.getSysImageName()%>">&nbsp;</a>
	                      <%}else if(cloudHost.getSysImageName().contains("indows2012")){%>
	        	      			<a href="javascirpt:;" class="newbtn windows2012" title="<%=cloudHost.getSysImageName()%>">&nbsp;</a>
	          	      	  <%}else if(cloudHost.getSysImageName().contains("entos6.4") || cloudHost.getSysImageName().contains("entos_6.4")){%>
	                  	  		<a href="javascirpt:;" class="newbtn centos6-4" title="<%=cloudHost.getSysImageName()%>">&nbsp;</a>
	                      <%}else if(cloudHost.getSysImageName().contains("entos6.5") || cloudHost.getSysImageName().contains("entos_6.5")){%>
	            	      		<a href="javascirpt:;" class="newbtn centos6-5" title="<%=cloudHost.getSysImageName()%>">&nbsp;</a>
	                      <%}else if(cloudHost.getSysImageName().contains("buntu12.04") || cloudHost.getSysImageName().contains("buntu_12.04")){%>
	      	      				<a href="javascirpt:;" class="newbtn ubuntu12-04" title="<%=cloudHost.getSysImageName()%>">&nbsp;</a>
	        	      	  <%}else if(cloudHost.getSysImageName().contains("buntu14.04") || cloudHost.getSysImageName().contains("buntu_14.04")){%>
    	      					<a href="javascirpt:;" class="newbtn ubuntu14-04" title="<%=cloudHost.getSysImageName()%>">&nbsp;</a>
  	        	      	  <%}else{%>
		                        <a href="javascirpt:;" class="newbtn default-system" title="未知系统">&nbsp;</a>
		                  <%} %>
	                   <%}else{ %>
	                   	  <%if(cloudHost.getSysImageNameOld()!=null && cloudHost.getSysImageNameOld().contains("indows7")){%>
	                      		<a href="javascirpt:;" class="newbtn windows7" title="<%=cloudHost.getSysImageNameOld()%>">&nbsp;</a>
	                      <%}else if(cloudHost.getSysImageNameOld()!=null && cloudHost.getSysImageNameOld().contains("indows2003")){%>
	                    	  	<a href="javascirpt:;" class="newbtn windows2003" title="<%=cloudHost.getSysImageNameOld()%>">&nbsp;</a>
	                      <%}else if(cloudHost.getSysImageNameOld()!=null && cloudHost.getSysImageNameOld().contains("indows2008")){%>
	              	      		<a href="javascirpt:;" class="newbtn windows2008" title="<%=cloudHost.getSysImageNameOld()%>">&nbsp;</a>
	                      <%}else if(cloudHost.getSysImageNameOld()!=null && cloudHost.getSysImageNameOld().contains("indows2012")){%>
	        	      			<a href="javascirpt:;" class="newbtn windows2012" title="<%=cloudHost.getSysImageNameOld()%>">&nbsp;</a>
	          	      	  <%}else if(cloudHost.getSysImageNameOld()!=null && (cloudHost.getSysImageNameOld().contains("entos6.4") || cloudHost.getSysImageNameOld().contains("entos_6.4"))){%>
                	  			<a href="javascirpt:;" class="newbtn centos6-4" title="<%=cloudHost.getSysImageNameOld()%>">&nbsp;</a>
	                      <%}else if(cloudHost.getSysImageNameOld()!=null && (cloudHost.getSysImageNameOld().contains("entos6.5") || cloudHost.getSysImageNameOld().contains("entos_6.5"))){%>
	          	      			<a href="javascirpt:;" class="newbtn centos6-5" title="<%=cloudHost.getSysImageNameOld()%>">&nbsp;</a>
	                      <%}else if(cloudHost.getSysImageNameOld()!=null && (cloudHost.getSysImageNameOld().contains("buntu12.04") || cloudHost.getSysImageNameOld().contains("buntu_12.04"))){%>
	    	      				<a href="javascirpt:;" class="newbtn ubuntu12-04" title="<%=cloudHost.getSysImageNameOld()%>">&nbsp;</a>
	      	      	  	  <%}else if(cloudHost.getSysImageNameOld()!=null && (cloudHost.getSysImageNameOld().contains("buntu14.04") || cloudHost.getSysImageNameOld().contains("buntu_14.04"))){%>
		      					<a href="javascirpt:;" class="newbtn ubuntu14-04" title="<%=cloudHost.getSysImageNameOld()%>">&nbsp;</a>
        	      	  <%}else{%>
	                        	<a href="javascirpt:;" class="newbtn default-system" title="未知系统">&nbsp;</a>
	                       <%} %>
	                   <%} %>
...
<%--                           <input id="t1<%=cloudHost.getId() %>" class="host_name" onblur="changeHostName()" maxlength="100" name="" type="text" value="<%=cloudHost.getDisplayName()%>"/> --%>
                          <input id="t1<%=cloudHost.getId() %>" class="host_name"  onblur="changeHostName()"  maxlength="100" name="" type="text" value="<%=cloudHost.getDisplayName()%>"/>
                          <label for="t1<%=cloudHost.getId() %>" title="<%=cloudHost.getDisplayName() %>" class="smalllabel l" style="cursor:pinter; background:url(<%=request.getContextPath()%>/image/icon_edit.png) no-repeat center right"></label>
                         </div>
                        <%} %>
                      </div>
                    </div>
                    <div class="div2 l">
                    <div class="listicon l" style="width:105px">
                    ...
                    <%} %>
                    <div class="div4 l"><div class="l"><img src="<%=request.getContextPath() %>/image/icon_ip.png" width="20" height="20" alt=" " style="vertical-align:middle" title="外网IP:<%=cloudHost.getOuterIp()==null ? "" : cloudHost.getOuterIp()%> "/> <%=cloudHost.getOuterIp()==null ? "" : cloudHost.getOuterIp()%></div>
                      <div class="r"><img src="<%=request.getContextPath() %>/image/icon_bandwidth.png" width="20" height="20" alt=" " style="vertical-align:middle" /><%=cloudHost.getBandwidthText(0)%></div>
                    </div>
                  </div>
                  <%if("关机".equals(cloudHost.getSummarizedStatusText())) {%>
             ...
             <%--<tr>
              <td><div class="box">
                  <div class="listleft l">
                    <div class="div1 l">
                      <div class="listicon">
                        <a href="javascirpt:;" class="btn centos" title="CentOS 6.4 32bit">&nbsp;</a>
                        <div class="text">
                          <input id="t1" name="" type="text" value="Host_1"/>
                          <label for="t1" class="smalllabel l" style="cursor:pinter; background:url(image/icon_edit.png) no-repeat center right"></label>
                        </div>
                      </div>
                    </div>
                    <div class="div2 l">
                    ...
                    <div class="div4 l"><img src="<%=request.getContextPath() %>/image/icon_ip.png" width="20" height="20" alt=" " style="vertical-align:middle" /> 172.172.100.100
                      <div class="r"><img src="<%=request.getContextPath() %>/image/icon_bandwidth.png" width="20" height="20" alt=" " style="vertical-align:middle" /> 10M</div>
                    </div>
                  </div>
                  <div class="listright l"><a href="javascript:void(0);" class="btn btn1 l" title="开机">&nbsp;</a><a href="javascript:void(0);" class="btn btn2 alpha l" title="关机">&nbsp;</a><a href="javascript:void(0);" class="btn btn3 alpha l" title="重启">&nbsp;</a><a href="javascript:void(0);" class="btn btn4 alpha l" title="断开">&nbsp;</a><a href="javascript:void(0);" class="graybutton alpha l"><div class="r">进入主机</div>
                    <div class="btn9 l">&nbsp;</div>
                    </a><a href="javascript:void(0);" class="btn btn5 l" title="停用">&nbsp;</a><a href="javascript:void(0);" class="btn btn6 l" title="备案">&nbsp;</a><a href="javascript:void(0);" class="btn btn7 l" title="修改配置">&nbsp;</a><a href="javascript:void(0);" class="btn btn8 l" title="更多">&nbsp;</a> <a href="javascript:void(0);" class="graybutton l"><div class="r">资源监控</div>
                    <div class="btn10 l">&nbsp;</div>
                    </a></div>
                </div></td>
            </tr>
            <tr>
              <td><div class="box">
                  <div class="listleft l">
                    ...
                    <div class="div3 l"><strong class="gray">已停用</strong></div>
                    <div class="div4 l"><img src="<%=request.getContextPath() %>/image/icon_ip.png" width="20" height="20" alt=" " style="vertical-align:middle" /> 172.172.100.100
                      <div class="r"><img src="<%=request.getContextPath() %>/image/icon_bandwidth.png" width="20" height="20" alt=" " style="vertical-align:middle" /> 10M</div>
                    </div>
                  </div>
                  <div class="listright l">
                    <div class="listinfo">您的主机已停用，我们将为您保存数据至 2014/9/18 18:00，<br />
到期主机及数据将会删除。</div>
                    <a href="javascript:void(0);" class="graybutton r">恢复服务
                    <div class="btn11 l">&nbsp;</div>
                    </a></div>
                </div></td>
            </tr>
            <tr>
              <td><div class="box">
                  ...
                  <div class="listright l">
                    <div class="listinfo">您的主机正在创建中，预计3分钟后完成创建:</div>
                    <div id="progressbar1" class="easyui-progressbar my_progressbar"  style="width:240px;margin-left:20px;margin-top:0px;" value="17" text="云主机创建中({value}%)"></div>
                    <div id="progressbar2" class="easyui-progressbar my_progressbar"  style="width:240px;margin-left:20px;margin-top:0px;" value="60" text="云主机创建中({value}%)"></div>
				</div>
                </div></td>
            </tr>
            <tr>
              <td><div class="box">
                  <div class="listleft l">
                    <div class="div1 l">
                      <div class="listicon">
                        <a href="javascirpt:;" class="btn windows" title="Windows 2000 32bit">&nbsp;</a>
                        <div class="text">
                          <input id="t1" name="" type="text" value="Host_1"/>
                          <label for="t1" class="smalllabel l" style="cursor:pinter; background:url(image/icon_edit.png) no-repeat center right"></label>
                        </div>
                    ...
                    <div class="div3 l"><strong class="orange">CPU告警</strong></div>
                    <div class="div4 l"><img src="<%=request.getContextPath() %>/image/icon_ip.png" width="20" height="20" alt=" " style="vertical-align:middle" /> 172.172.100.100
                      <div class="r"><img src="<%=request.getContextPath() %>/image/icon_bandwidth.png" width="20" height="20" alt=" " style="vertical-align:middle" /> 10M</div>
                    </div>
                  </div>
                  <div class="listright l"><a href="javascript:void(0);" class="btn btn1 alpha l" title="开机">&nbsp;</a><a href="javascript:void(0);" class="btn btn2 l" title="关机">&nbsp;</a><a href="javascript:void(0);" class="btn btn3 l" title="重启">&nbsp;</a><a href="javascript:void(0);" class="btn btn4 l" title="断开">&nbsp;</a><a href="javascript:void(0);" class="graybutton l"><div class="r">进入主机</div>
                    <div class="btn9 l">&nbsp;</div>
                    </a><a href="javascript:void(0);" class="btn btn5 l" title="停用">&nbsp;</a><a href="javascript:void(0);" class="btn btn6 l" title="备案">&nbsp;</a><a href="javascript:void(0);" class="btn btn7 l" title="修改配置">&nbsp;</a><a href="javascript:void(0);" class="btn btn8 l" title="更多">&nbsp;</a> <a href="javascript:void(0);" class="graybutton l"><div class="r">资源监控</div>
                    <div class="btn10 l">&nbsp;</div>
                    </a></div>
      ...
      <div class="briefpage">
        ...
        <div class="content"><img src="<%=request.getContextPath() %>/image/brief_1_1.png" width="225" height="49" />
          ...
          <p>打开Windows自带<strong>“远程桌面连接”</strong>，输入云主机公网IP连接，<br />
            <br />
            默认用户名：<strong>administrator</strong>，默认密码：<strong>zhicloud@123</strong></p>
          ...
          <p>打开SSH工具，如<strong>“SSH Secure Shell”</strong>，输入云主机公网IP、用户名（默认<strong>root</strong>）、<br />
            <br />
            密码（默认<strong>zhicloud@123</strong>）后进入云主机系统。</p>
        </div>
