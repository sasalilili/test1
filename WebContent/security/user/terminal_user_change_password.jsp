			...
			<table style="margin: 10px 10px 10px 20px;">
				<tr>
					...
					<td style="padding:5px 0 5px 0">
						<input type="password" id="old_password" style="width:180px;height:23px" name="old_password" value="" onblur="checkOldPassword()"/>
					</td>
				...
				<tr>
					...
					<td style="padding:5px 0 5px 0">
						<input type="password" id="password" style="width:180px;height:23px" name="password" value="" onblur="checkPassword()"/>
					</td>
				...
				<tr>
					...
					<td style="padding:5px 0 5px 0">
						<input type="password" id="confirm" style="width:180px;height:23px" name="confirm" value="" onblur="checkPasswordConf()"/>
					</td>
