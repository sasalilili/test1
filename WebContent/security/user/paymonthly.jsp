		...
		<div class="pagebox">
			...
			<div class="main">
				<div class="container l">
					<div class="titlebar">
						<div class="tab">
                            <a href="<%=request.getContextPath()%>/user/buy.do">试  用</a>
                        </div>
						<div class="tab tabactive">
							包月使用
						</div>
						<div class="tab">
							<a href="<%=request.getContextPath()%>/user/buy.do?flag=asquantity">按量付费</a>
						</div>
					</div>
					<div class="content">
						<form action="" id="cart_form" method="post">
							<input name="type" type="hidden" value="1" /> 
							<input name="price" type="hidden" value="3" /> 
							...
							<select id="sys_image_id" name="sys_image_id" class="easyui-radio">
								<option value=""></option>
								<%
							...
							&nbsp;<input class="tinyfield" name="duration" id="duration"
								type="text" />
							<div class="unit">个月</div>
							<div class="clear">&nbsp;</div>
							<span>金额</span>
							<div class="price">
								<b>3.00</b> 元/月
...
var _terminal_user_add_dlg_scope_ = new function(){
			...
			function(reply) {
				if (reply.status == "exception") {
					...
					window.setTimeout(function(){
						window.location.href="<%=request.getContextPath()%>/user/buy.do?flag=monthly"; 
					}, 500);
				} else {
	...
	$(document).ready(function(){
		...
		$("#toLogin").click(function() {
			var url = encodeURIComponent($("#url").val()+"/user/buy.do?flag=monthly"); 
