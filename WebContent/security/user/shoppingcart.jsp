		...
		<div class="pagebox">
			...
			<div class="nav">
				<div class="navbox">
					...
					<div class="navbutton l"  ><a href="#" class="easyui-menubutton" data-options="menu:'#productmenu'">产品</a></div>
                    <div class="navsplitter l">&nbsp;</div>
					<div class="navbutton l"  >
		        ...
		        <div class="fulltable">
		          ...
		          <table class="paytable" cellspacing="0">
		            ...
		            <tr class="evenrow">
		              ...
		              <td class="remove" width="16"><a href="#" onclick="deleteDetail('<%=vo.getId()%>','<%=vo.getPrice() %>');"><img src="<%=request.getContextPath()%>/images/button_remove_gray_16_16.png" width="16" height="16" alt="删除" /></a></td>
		            </tr>
		            <%
		              } 
		            %> 
		            <tr class="lastrow">
		              <td colspan="2" class="tools"><input id="sall2" checked="checked" name="getall" type="checkbox" value="" onchange="getAll(this)" /> <label for="sall2">全选</label><a id="removebutton" class="removebutton" href="#" onclick="deleteDetail();">删除</a> </td>
   ...
   function logout(){
	...
	function addPort(){
		...
		if(flag==true){
			...
			$("#showports").append("<a href='#' onclick='deletePort($(this));'>"+port+ "</a>");
			var val = $("#ports").val();
		    val = val + port+",";
		    $("#ports").val(val);
			$("#port").val(""); 
