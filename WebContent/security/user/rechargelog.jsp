      ...
      <div class="box" style="margin-top:30px;">
        ...
        <div class="r" style="width:450px;">
          <div class="titlebar2" style="text-align:right">
            <div class="tabbar l"><a href="#"  id="consumption_list_show_btn">消费记录</a>　｜　<a href="#" class="active" id="recharge_list_show_btn">充值记录</a></div>实际充值总额<b>：<%=all %></>元</b></div>
          
          <div id="recharge_record_1"    >
