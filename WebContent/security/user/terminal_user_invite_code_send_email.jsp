...
<div id="send_invite_code_email_dlg_container">
	<div id="send_invite_code_email_dlg" class="easyui-dialog" title="发送邀请码" 
			style="
				width:380px; 
				height:200px; 
				padding:15px;
			...
			">
		<form id="send_invite_code_email_dlg_form" method="get">
...
_send_invite_code_email_dlg_scope_.save = function()
{
	...
	ajax.remoteCall("bean://inviteCodeService:sendInviteCodeByEmail",
		[formData],
		function(reply)
		{
