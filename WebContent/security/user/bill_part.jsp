...
<%
	List<AccountBalanceDetailVO> billDetailList = (List<AccountBalanceDetailVO>)request.getAttribute("billDetailList");
	...
	for( AccountBalanceDetailVO bill : billDetailList )
	{
%>
		...
		<tr>
			<td>
				<div>
					...
					<span class="bill_item_label">总价：<%=bill.getAmount()%>元</span>
					<span class="bill_item_label">时间：<%=StringUtil.formatDateString(bill.getChangeTime(), "yyyyMMddHHmmssSSS", "yyyy-MM-dd")%></span>
