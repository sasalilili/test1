...
<div id="sys_role_add_dlg_container">
	<div id="sys_role_add_dlg" class="easyui-dialog" title="添加角色" 
			style="
				width:435px; 
				height:150px; 
				padding:10px;
		...
		<form id="sys_role_add_dlg_form" method="post">
			<table border="0" cellpadding="0" cellspacing="0">
			    <tr>
			      ...
			      <td class="inputcont"><input class="textbox inputtext" type="text" id="role_name" name="role_name" onblur="checkRoleName()"/></td>
			      <td class="inputtip" id="admin-tip-rolename"><i>请输入角色名</i></td>
			    </tr>
			</table>
		</form>
	</div>
...
_sys_role_add_dlg_scope_.save = function()
{
	...
	ajax.remoteCall("bean://sysRoleService:addSysRole",
		[formData],
		function(reply)
		{
