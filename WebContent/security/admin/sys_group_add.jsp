...
<div id="sys_group_add_dlg_container">
	<div id="sys_group_add_dlg" class="easyui-dialog" title="添加权限组" 
			style="
				width:370px; 
				height:150px; 
				padding:10px;
		...
		<table border="0" cellpadding="0" cellspacing="0">
		    <tr>
		      ...
		      <td class="inputcont"><input class="textbox inputtext" type="text" id="group_name" name="groupName" onblur="checkGroupName()"/></td>
		      <td class="inputtip" id="admin-tip-groupname"><i>请输入权限组名</i></td>
		    </tr>
		</table>
		</form>
	</div>
...
//================================
var _sys_group_add_dlg_scope_ = {};		// 作用域
_sys_group_add_dlg_scope_.onMove = function(){
...
// 保存
_sys_group_add_dlg_scope_.save = function()
{
	var formData = $.formToBean(sys_group_add_dlg_form);
	ajax.remoteCall("bean://sysGroupService:addSysGroup",
		[formData],
		function(reply)
		{
...
// 关闭
_sys_group_add_dlg_scope_.close = function()
{
	$("#sys_group_add_dlg").dialog("close");
};
...
$("#sys_group_add_dlg_save_btn").click(function(){
	if(checkGroupName()){
		_sys_group_add_dlg_scope_.save();
	}
});

// 关闭
$("#sys_group_add_dlg_close_btn").click(function(){
	_sys_group_add_dlg_scope_.close();
});
