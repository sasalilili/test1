...
<html>
		...
		<form id="operator_update_password" method="post">
			...
			<table style="margin: 10px 10px 10px 20px;">
				<tr>
					...
					<td class="inputtip" id="agent-tip-oldPassword"></td>
				</tr>
				<tr>
					...
					<td><span id="agent-tip-password"></span></td>
				</tr>
				<tr>
					...
					<td><span id="agent-tip-confirm"></span></td>
				</tr>
				<tr>
					<td></td>
	...
	function checkOldPassword(){
		...
		if(oldPassword==null || oldPassword==""){
			$("#agent-tip-oldPassword").html("<font color='red'>原密码不能为空</font>");
			return false;
		}
		else
		{	
			$("#agent-tip-oldPassword").html("");
			return true;
		}
	...
	function checkPassword(){
		...
		if(myPassword==null || myPassword==""){
			$("#agent-tip-password").html("<font color='red'>新密码不能为空</font>");
			return false;
		}
		if(myPassword==oldPassword)
		{
			$("#agent-tip-password").html("<font color='red'>新密码和原密码一样</font>");
			return false;
		}
// 		if(/^\w{8,20}$/.test(myPassword)){
// 			$("#agent-tip-password").html("");
// 			return true;
// 		}
		...
		$("#agent-tip-password").html("<font color='red'>密码长度为6-20个字符</font>");
			return false;
	}
	function checkPasswordConf(){
		...
		if(passwordTwo==null || passwordTwo==""){
			$("#agent-tip-confirm").html("<font color='red'>确认密码不能为空</font>");
			return false;
		}
		if(passwordOne!=passwordTwo){
			$("#agent-tip-confirm").html("<font color='red'>两次输入的密码不一致</font>");
			return false;
		}
		$("#agent-tip-confirm").html("");
		return true;
	}
