...
<div id="cloud_host_view_detail_dlg_container">
	<div id="cloud_host_view_detail_dlg" class="easyui-dialog" title="云主机详情"
		...
		function refreshData(){ 
			...
			ajax.remoteCall("bean://cloudHostService:refreshData", 
					...
					function(reply) {
						...
						memoryArray[6] = reply.result.memoryUsage;
						require.config({
					        paths:{
					                    ...
					                    series : [
					                        {
					                            ...
					                            center: ['50%', '50%'],
					                            data:[
					                                {value:reply.result.sysDiskUsage,name:'已使用',itemStyle:{
					                                    normal:{
					                                ...
					                                {value:reply.result.sysDisk-reply.result.sysDiskUsage,name:'未使用',itemStyle:{
					                                    normal:{
					                    ...
					                    series : [
					                        {
					                            ...
					                            left: ['50%', '50%'],
					                            data:[
					                                {value:reply.result.dataDiskUsage, name:'已使用',itemStyle:{
					                                    normal:{
					                                ...
					                                {value:reply.result.dataDisk-reply.result.dataDiskUsage, name:'未使用',itemStyle:{
					                                    normal:{
